...
**
** Created: Thu Mar 19 09:55:27 2015
...
static const char qt_meta_stringdata_MailClient[] = {
    "MailClient\0"
};
...
const QMetaObjectExtraData MailClient::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MailClient::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MailClient,
      qt_meta_data_MailClient, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MailClient::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MailClient))
