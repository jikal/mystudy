...
**
** Created: Thu Mar 19 09:56:18 2015
...
static const char qt_meta_stringdata_ProjectListWidget[] = {
    "ProjectListWidget\0"
};
...
const QMetaObjectExtraData ProjectListWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProjectListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_ProjectListWidget,
      qt_meta_data_ProjectListWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ProjectListWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProjectListWidget))
